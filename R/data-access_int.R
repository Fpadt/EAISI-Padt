...
#'
#' @keywords internal
.da_duckdb_components_get <- function(
    .vtype       = NULL,
    .ftype       = NULL,
    .material    = NULL,
    .salesorg    = NULL,
  ...
  cte_scope_materials <- .da_matl_scope_cte_get(
    .scope_matl = .scope_matl,
    .con        = con
  )
...
.da_where_clause_get <- function(
  ...
  # matl_scope <- .da_matl_scope_get(.con = .con)
...
#' @importFrom DBI SQL
#' @keywords internal
.da_matl_scope_cte_get <- function(.scope_matl, .con) {
