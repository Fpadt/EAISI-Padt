...
# Pythia's Advice - Datascience Tooling 

<a href="https://pythia.smart-r.nl" target="_blank" rel="noopener noreferrer">
  <img src="man/figures/padt_wttxt.png" alt="Pythia's Advice logo" align="right" height="138" />
</a>
...
```markdown
<img src="man/figures/padt_wttxt.png" alt="Pythia's Advice logo" width="80%" />
```
...
The project is developed in R and Python.
